            ...
            Container(
                ...
                decoration: const BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage("assets/landmarks.png"),
                      fit: BoxFit.cover),
            ...
            Visibility(
              ...
              child: Container(
                ...
                child: ElevatedButton(
                    ...
                    child: const Text("Register a Landmark",
                        style: TextStyle(
                          fontSize: 20,
                          fontFamily: 'Quicksand',
                                          ...
                                          child: ClipRRect(
                                              ...
                                              child: Container(
                                                decoration: BoxDecoration(
                                                  ...
                                                  fit: BoxFit.fill,
                                                  image: NetworkImage(
                                                      'https://mid-tourism.up.railway.app/media/${snapshot.data![index].fields.image}'),
                                                )),
                                              )))
                                    ])),
                                Expanded(
                                                              ...
                                                              onPressed:
                                                                ...
                                                                try {
                                                                  final response =
                                                                      await request
                                                                          .get(
                                                                              'https://mid-tourism.up.railway.app/landmarks/delete_landmark_flutter/${snapshot.data![index].pk}');
                                                                } catch (e) {
                                                                  print(
                                                                      "$e LOOK");
                                                                }
